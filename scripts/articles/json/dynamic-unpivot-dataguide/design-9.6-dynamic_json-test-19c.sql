...
prompt unpivot datasource with pivoted quarterly sales
...
/*
design--9.6-dynamic_json-test-19c.sql
for Oracle 19c use clob datatype for json document
reset the random seed to keep values the same for each execution
unpivot datasource with pivoted quarterly sales

...
column uint_byte format 9


prompt use bin_to_num to convert pivoted bits to uint8 bytes
prompt each set of 8 dimensions should pack to a byte value of 42
with base as (
    select
        1 as id
        , to_vector(
...
use bin_to_num to convert pivoted bits to uint8 bytes
each set of 8 dimensions should pack to a byte value of 42

...
column id format 9
column textual_input format a20

prompt use json_arrayagg to combine the bytes into an array
prompt serialize this as textual input for the binary vector
with base as (
    select
        1 as id
        , to_vector(

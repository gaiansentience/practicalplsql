...
declare
    ...
    is
    begin
        dbms_output.put_line('# vector quantized with macro in database');
        show(p_vector);
        ...
        dbms_output.put_line('from sentence_transformers.quantization import quantize_embedddings');
...
begin
     ...
     t := '[-0.123, -0.654, 0.345, -0.02, 0.789, -0.567, 0.888, 0, -0.123, -0.444, -0.65, -0.02, 0.231, -0.11, 0.73, 0]';
     v := to_vector(t);
     script(v);

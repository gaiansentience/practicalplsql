...
begin
    ...
    begin
        ...
        insert into customer_loyalty set customer_id = l_customer_id, status_id = l_status_id;
    
        dbms_output.put_line('#Place valid orders: Nina, New, [0, 0.05]');    
        insert into orders set customer_id = l_customer_id, discount = 0;
        insert into orders set customer_id = l_customer_id, discount = 0.05;
        ...
        insert into orders set customer_id = l_customer_id, discount = 0.10;            
        insert into orders set customer_id = l_customer_id, discount = 0.11;
    ...
    begin
        ...
        begin
            ...
            from customers where customer_name = 'Prue';
        ...
        begin
            ...
            select customer_id into l_customer_id
            from customers where customer_name = 'Liza';
...
begin
    ...
    begin
        ...
        select customer_id into l_customer_id
        from customers where customer_name = 'Nina';
        
        select status_id into l_status_id
        from loyalty where status = 'Preferred';
        ...
        set customer_id = l_customer_id, status_id = l_status_id, effective = l_change_date;
    ...
    begin
        begin
            ...
            insert into orders set customer_id = l_customer_id, discount = 0.01;
        exception
            when others then
                rollback;
                dbms_output.put_line(sqlerrm);
...
begin
    ...
    begin
        ...
        select status_id into l_status_id
        from loyalty where status = 'Elite';
...
begin
    ...
    begin
        ...
        set status_id = l_status_id, discount_min= 0.0625, discount_max = 0.1625, effective = l_change_date;
        ...
        insert into loyalty_discounts
        set status_id = l_status_id, discount_min= 0.1125, discount_max = 0.2125, effective = l_change_date;
    ...
    begin
        ...
        insert into orders set customer_id = l_customer_id, discount = 0.07;
        insert into orders set customer_id = l_customer_id, discount = 0.065;
            
        dbms_output.put_line('#Place valid order: Nina, Elite, 0.12');
        select customer_id into l_customer_id
        from customers where customer_name = 'Nina';

        insert into orders set customer_id = l_customer_id, discount = 0.12;

...
select 
    interval_value
    , round(interval_value / 5, 'MI') * 5 as use_round_to_5
    , increment_minutes_interval(interval_value, 5) as to_5_minutes
    , increment_minutes_interval(interval_value, 90) as to_10_minutes
    , increment_minutes_interval(interval_value, 15) as to_15_minutes
    , increment_minutes_interval(interval_value, 1/2) as to_half_minutes
from base

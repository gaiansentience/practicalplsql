...
declare
    i number;
    l_table varchar2(100) := 'ext$postal_codes$geonames';
begin
...
DECLARE
  l_TABLE_NAME        DBMS_QUOTED_ID := 'EXT$POSTAL_CODES$GEONAMES';
  l_CREDENTIAL_NAME   DBMS_QUOTED_ID := '"OCI$RESOURCE_PRINCIPAL"';
  l_FILE_URI_LIST     CLOB :=
    q'['https://objectstorage.us-ashburn-1.oraclecloud.com/n/idjv1ptikjf5/b/adw_ext_data/o/geodata/postal-codes-geonames-*.csv']';
  l_COLUMN_LIST       CLOB :=
    q'[
